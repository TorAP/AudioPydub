...
while True:
    ...
    if frame is None and read_success == False:
        raise Exception("The webcamera could not be recognized.")
    ...
    # IN VIDEO FEED
        ...
        if not post_calibration:
            #region -- CALIBRATION --------------------------------------------
            calibInfo = cv2.imread(resource_path("calib.png"))
            ...
            try:
                ...
                if m == 2:
                    UI_source = resource_path(str(n) + ".png")
                    ...
                    if m == 1:
                        UI_source = resource_path("no.png")

                    else:
                        UI_source = resource_path("alien.png")
                ...
                UI = cv2.imread(resource_path("warning.png"))
